...
if(isset($_POST['b1'])){
    ...
    $gender=$_POST['g1'];
    $district=$_POST['s1'];
    mysqli_query($con,"UPDATE employee_tbl SET employee_name='$name',designation='$des',joining_date='$date',age='$age',gender='$gender',district='$district'WHERE emp_id='$del'");
